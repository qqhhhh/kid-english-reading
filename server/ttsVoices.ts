import type { TtsVoice } from "./types/providers.js";

export const tencentTtsVoices: readonly TtsVoice[] = [
  {
    id: "501008",
    provider: "tencent",
    name: "WeJames",
...
export function getDefaultTtsVoice(): TtsVoice {
  return (
...
export function findTtsVoice(voiceId?: string | null): TtsVoice | undefined {
  if (!voiceId) {
