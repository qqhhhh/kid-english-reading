import type { AssessmentResultLike, AssessmentWordLike } from "./assessmentTypes.js";

export type { AssessmentResultLike, AssessmentWordLike } from "./assessmentTypes.js";

export interface WordAccuracyMetrics {
  totalCount: number;
  clearCount: number;
...
export function getWordAccuracyMetrics(result?: AssessmentResultLike | null): WordAccuracyMetrics {
...
export function getEffectiveFluency(result?: AssessmentResultLike | null): number {
...
export function getRequiredWordScore(word?: AssessmentWordLike | null): number {
