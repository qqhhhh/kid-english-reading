  ...
  return (
    <main className="platform-admin-page">
      <header className="platform-admin-header">
        <div><ShieldCheck size={28} /><span><small>自托管服务器</small><strong>平台课程管理</strong></span></div>
        <nav>
      ...
      <section className="platform-admin-grid is-platform-console">
        <section className="platform-resource-panel">
          <div className="platform-panel-heading"><span><BookOpen size={20} /></span><div><small>服务器当前资源</small><h1>已发布课程</h1></div></div>
